...
export const ONBOARDING_SLIDES: OnboardingSlide[] = [
  ...
  },
  {
    ...
    body: 'Tell Navia where you’re headed and what you’re into. It drafts the route, the stops and the pacing, then you shape it from there instead of starting from a blank page.',
  },
  {
    slug: 'reality-check',
    ...
    body: 'Travel time between stops, overloaded days, places that have closed: all measured against real data, not guessed. You find out before you’re standing outside a shuttered door.',
  },
];
