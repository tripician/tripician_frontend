    ...
    <InfoPageShell>
      ...
      <Box sx={{ background: 'linear-gradient(135deg,#FFF5F6 0%,#FFFAFA 100%)', borderBottom: '1px solid rgba(0,0,0,0.06)', px: { xs: 3, md: 8 }, py: { xs: 6, md: 8 } }}>
        <Container maxWidth="md">
          ...
          <Typography sx={{ fontSize: '1.05rem', color: '#666', lineHeight: 1.75 }}>
            ...
            <Box component="a" href="mailto:support@tripician.com" sx={{ color: 'primary.main', fontWeight: 600, textDecoration: 'none', '&:hover': { textDecoration: 'underline' } }}>support@tripician.com</Box>.
          </Typography>
        </Container>
      </Box>
      ...
      <Container maxWidth="md" sx={{ py: { xs: 5, md: 8 } }}>
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 280px' }, gap: 3, alignItems: 'flex-start' }}>
          ...
          >
            <Typography variant="h4" component="h2" sx={{ mb: 3 }}>Send us a message</Typography>
            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' }, gap: 2, mb: 2 }}>
              <TextField
                ...
                fullWidth
                required
                sx={{ '& .MuiOutlinedInput-root.Mui-focused fieldset': { borderColor: 'primary.main' }, '& label.Mui-focused': { color: 'primary.main' } }}
              />
              <TextField
                label="Your email"
                name="email"
            ...
            <TextField
              ...
              size="small"
              fullWidth
              sx={{ mb: 2, '& .MuiOutlinedInput-root.Mui-focused fieldset': { borderColor: 'primary.main' }, '& label.Mui-focused': { color: 'primary.main' } }}
            />
            <TextField
              label="Your message"
              name="message"
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
            <Box sx={{ background: '#fff', borderRadius: '14px', p: 3, border: '1px solid rgba(0,0,0,0.07)', boxShadow: '0 2px 12px rgba(0,0,0,0.04)' }}>
              ...
              <Box
                ...
                sx={{ display: 'block', fontSize: '0.88rem', color: 'primary.main', fontWeight: 700, wordBreak: 'break-all', textDecoration: 'none', '&:hover': { textDecoration: 'underline' } }}
              >
            ...
            <Box sx={{ background: '#fff', borderRadius: '14px', p: 3, border: '1px solid rgba(0,0,0,0.07)', boxShadow: '0 2px 12px rgba(0,0,0,0.04)' }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 1.5 }}>
                <AccessTimeRoundedIcon sx={{ color: 'primary.main', fontSize: 22 }} />
            ...
            <Box sx={{ background: '#FFF5F6', borderRadius: '14px', p: 3, border: `1px solid ${alpha(BRAND.coral, 0.1)}` }}>
              <Typography sx={{ fontSize: '0.82rem', color: '#555', lineHeight: 1.7 }}>
                ...
                <Box component={Link} to="/privacy-policy" sx={{ color: 'primary.main', fontWeight: 600, textDecoration: 'none', '&:hover': { textDecoration: 'underline' } }}>
