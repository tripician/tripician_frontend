...
const Signup = () => {
    ...
    const handleGoogleSignUp = () => { /* TODO: wire up Google OAuth */ };
    const handleFacebookSignUp = () => { /* TODO: wire up Facebook OAuth */ };
    const handleRedditSignUp = () => { /* TODO: wire up Reddit OAuth */ };
