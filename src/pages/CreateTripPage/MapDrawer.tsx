  ...
  return (
    ...
    >
      ...
      <Box sx={{
        ...
        px: 2.5, py: 1.75,
        background: isLight
          ? `linear-gradient(135deg, #fff 0%, ${alpha(BRAND.coral, 0.04)} 100%)`
          : `linear-gradient(135deg, #18181b 0%, ${alpha(BRAND.coral, 0.06)} 100%)`,
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.25 }}>
          ...
          <Box>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mt: 0.2 }}>
              <RouteIcon sx={{ fontSize: 11, color: 'primary.main' }} />
        ...
        <IconButton
          ...
          sx={{
            ...
            '&:hover': { bgcolor: isLight ? alpha(BRAND.coral, 0.09) : alpha(BRAND.coral, 0.14), color: 'primary.main' },
          }}
        >
        ...
        <Box sx={{
          ...
          {mappable.map(({ dest, index }) => (
            <Box key={dest.id || index} sx={{
              ...
              bgcolor: isLight ? alpha(BRAND.coral, 0.07) : alpha(BRAND.coral, 0.12),
              border: `1px solid ${alpha(BRAND.coral, 0.20)}`,
              borderRadius: '14px', px: 1.1, py: 0.35,
            }}>
              <Box sx={{
                width: 16, height: 16, borderRadius: '50%',
                background: `linear-gradient(135deg, ${BRAND.coralLight}, ${BRAND.coralDeep})`,
                display: 'flex', alignItems: 'center', justifyContent: 'center',
